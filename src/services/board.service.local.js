            ...
            checklists: [
              {
                ...
                todos: [
                  ...
                  {
                    title:
                      '16 oz chicken or vegetable stock (for homemade enchilada sauce)',
                    isDone: false,
                    id: 'TDc3kjU',
                  },
                  {
            ...
            checklists: [
              {
                ...
                todos: [
                  ...
                  {
                    title:
                      'Salt, boullion cubes, soy sauce, or Worchestershire sauce',
                    isDone: false,
                    id: 'TDR3jJ2',
                  },
                  {
      ...
      },
      {
        ...
        cards: [
          ...
          },
          {
            ...
            title: 'Ship iOS app',
            description:
              'The mobile team has released an Android app and is now working on v2 of the iOS app.',
            comments: [],
            checklists: [],
            members: [],
            labelIds: ['8g0M9'],
      ...
      },
      {
        ...
        cards: [
          ...
          },
          {
            ...
            description:
              "Blog for recruiting purposes where developers can post about what they're working on. ",
            comments: [],
            checklists: [
              {
                title: 'Checklist',
      ...
      },
      {
        ...
        cards: [
          ...
          },
          {
            id: 'CJH0W9',
            title:
              'Bravo to Lauren for taking the lead and finishing the new landing page design!',
            description: '',
            comments: [],
            checklists: [],
            members: [],
...
function _createBoards() {
  ...
  if (!boards || !boards.length) {
    boards = [travelBoard(), mealPlanner(), companyBoard()];
...
function travelBoard() {
  ...
  think.cards[5].description =
    'How much can we fit into one day? Have we taken travel times into account?';
